...
if { $list_projs eq "" } {
   create_project fir15 vivado_project -part xczu7ev-ffvc1156-2-e
   set_property BOARD_PART xilinx.com:zcu104:part0:1.1 [current_project]
   add_files -norecurse {./src/MultiCycleAdder.v ./src/myFIR.v}
}


# CHANGE DESIGN NAME HERE
variable design_name
set design_name fir15
...
proc create_root_design { parentCell } {
  ...
  # Create instance: myFIR_0, and set properties
  set block_name myFIR
  set block_cell_name myFIR_0
  if { [catch {set myFIR_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins myFIR_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net myFIR_0_M_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins myFIR_0/M_AXIS]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins myFIR_0/rst_n]
