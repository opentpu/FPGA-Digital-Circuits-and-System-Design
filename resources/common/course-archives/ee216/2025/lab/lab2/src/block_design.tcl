...
proc create_root_design { parentCell } {
  ...
  # Create instance: myAXIS_0, and set properties
  set block_name myAXIS
  set block_cell_name myAXIS_0
  if { [catch {set myAXIS_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins myAXIS_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net myAXIS_0_M_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins myAXIS_0/M_AXIS]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins myAXIS_0/ARESERTn]
